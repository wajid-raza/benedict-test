...
customElements.define('account-icon', AccountIcon);
 ...
 const closeButton = document.querySelector('.close_poup');
    const popup = document.querySelector('.quickview_popup');

    // Add a click event listener to the close button
    closeButton.addEventListener('click', function() {
        // Remove the active class from the popup element
          document.querySelector(".quickview_popup .quickview_pro_inner").innerHTML = "";
